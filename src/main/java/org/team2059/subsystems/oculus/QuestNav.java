package org.team2059.subsystems.oculus;
...
public class QuestNav {
  ...
  private Rotation2d yawOffset = Rotation2d.fromDegrees(0);
  ...
  public void setPose(Pose2d target) {
    offset = new Transform2d(new Pose2d(getTranslation(), getYaw()), target);
  }

  public void setHeading(double desiredHeading) {
//    questMosi.set(Command.RESET_HEADING);
//    yawOffset = Rotation2d.fromDegrees(-questEulerAngles.get()[1] - desiredHeading);
    double offset = -questEulerAngles.get()[1] - desiredHeading;
    yawOffset = Rotation2d.fromDegrees(offset);
  }

  public void pingHeadset() {
    questMosi.set(Command.PING);
  }
  ...
  public void cleanupResponses() {
    Logger.recordOutput("QuestMiso", questMiso.get());
  ...
  public Rotation2d getYaw() {
    return Rotation2d.fromDegrees(-questEulerAngles.get()[1]).minus(yawOffset);
  }
  ...
  public Pose2d getPose() {
    return new Pose2d(getTranslation(), getYaw()).transformBy(offset);
  }
}